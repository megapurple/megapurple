<template>
  <div class="link-mask" v-show="value">
    <div class="link-box">
      <div class="title">
        Link wallet
        <img
    ...
    async linkWallet(item) {
      if (item.name === "OKX") {
        ...
        try {
          ...
          window.open(
            "https://chromewebstore.google.com/detail/magic-eden-wallet/mkpegjkblkkefacfnmkajcjmabijhclg?hl=zh-CN&utm_source=ext_sidebar"
          );
        }
      }
    },
